...
def get_model(input_dim: int,
    ...
    m1 = L.Conv1D(4, kernel_size=3, padding="causal", activation="swish", name="mel_br_k3")(mel_log)
    m2 = L.Conv1D(4, kernel_size=7, padding="causal", activation="swish", name="mel_br_k7")(mel_log)
    m3 = L.Conv1D(4, kernel_size=15, padding="causal", activation="swish", name="mel_br_k15")(mel_log)
    ...
    # -------------------------- Latent attention ------------------------------ #
    # Disabled for memory savings; keep backbone output.
